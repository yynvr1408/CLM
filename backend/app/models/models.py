...
class Clause(Base):
    ...
    contracts = relationship("ContractClause", back_populates="clause", cascade="all, delete-orphan")
    template_clauses = relationship("TemplateClause", back_populates="clause", cascade="all, delete-orphan")
