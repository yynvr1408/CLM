...
def create_approval(
    ...
    approval = WorkflowService.create_approval(db, contract_id, approval_data)
    return approval
...
def approve_contract(
    ...
    """Approve contract."""
    approval = WorkflowService.approve_contract(
        db,
        approval_id,
        current_user.id,
        comments=comments
...
def reject_contract(
    ...
    """Reject contract."""
    approval = WorkflowService.reject_contract(
        db,
        approval_id,
        current_user.id,
        comments=comments
